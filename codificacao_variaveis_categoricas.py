...
#qcodificação one-hota para 'estado-civil'
...
print("\nDataFrame após transformar 'area_atuacao' em código numérico:\n", df.head())

# labelEnacoder para 'estado'
# LabelEncoder converte cada valopra único em números de 0 a n_classes-1
